<?php require_once 'super/superhead.php' ?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>PICKAPP Admin Panel</title>
...
<div class="app-container app-theme-white">
        ...
        <div class="app-header header-shadow">
            <div class="container fiori-container">
                ...
                <div class="">
                    <a href="#">
                      <img src="../assets/images/logos/pickapp_logos.jpg" height="80" width="auto" />
                    </a>
                </div>
                <ul class="horizontal-nav-menu">
                    ...
                    <li class="dropdown">
                        <a  data-toggle="dropdown" data-offset="10" data-display="static" aria-expanded="false">
                            <i class="nav-icon-big typcn typcn-location"></i>
                            <span>Tracker</span>
                        </a>
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-vicious-stance">
                                            ...
                                            <div class="menu-header-content text-white">
                                                <h5 class="menu-header-title">Extra Menu</h5>
                                                <h6 class="menu-header-subtitle">something</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="grid-menu grid-menu-xl grid-menu-3col">
                                        <div class="no-gutters row">
                                            <div class="col-sm-6 col-xl-4">
                                                <a href="analytics-dashboard.html" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="nav-icon-big typcn typcn-chart-line btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Analytics
                                                </a>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <a href="management-dashboard.html" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="nav-icon-big typcn typcn-group-outline btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Management
                                                </a>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <a href="advertisement-dashboard.html" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="nav-icon-big typcn typcn-video btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Advertisement
                                                </a>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <a href="monitoring-dashboard.html" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="nav-icon-big typcn typcn-eye btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Monitoring
                                                </a>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <a href="statistics-dashboard.html" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                  <i class="nav-icon-big typcn typcn-chart-pie btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Statistics
                                                </a>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <a href="product-dashboard.html" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                  <i class="nav-icon-big typcn typcn-dropbox btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Product
                                                </a>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="menu-header-content text-left">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading"><?php echo $username ?>
                                                                    </div>
                        ...
                        <div class="container fiori-container">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div>
                                        PICKAPP
                                        <div class="page-title-subheading">Get the Best System to Track your Product
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav">
                                        <li class="nav-item">
                                            ...
                                            <a href="#" class="nav-link close-menu-btn">
                                                ...
                                                <span class="hide-text-md">CLOSE</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="app-inner-layout__sidebar">
                                <div class="app-layout__sidebar-inner dropdown-menu-rounded">
                                    <div class="nav flex-column">
                                        ...
                                        <a class="dropdown-item" href="#" data-toggle="dropdown" id="driver" aria-haspopup="true" aria-expanded="false">Register Driver
                                          <i class="nav-icon-big typcn typcn-th-menu-outline dropdown-toggle" style="float:right;" ></i>
                                        </a>
                                          <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-sm rm-pointers dropdown-menu dropdown-menu-left">
                                              <div class="scroll-area-xs">
                                                  <div class="scrollbar-container">
                                                      <ul class="nav flex-column">
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Register Driver</a></li>
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">View All Drivers</a></li>
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">View All Payment</a></li>
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">KYC</a></li>
                                                      </ul>
                                                  </div>
                                              </div>
                                          </div>

                                        <a class="dropdown-item en" href="#" data-toggle="dropdown" id="courier" aria-haspopup="true" aria-expanded="false">Courier Company's
                                          <i class="nav-icon-big typcn typcn-th-menu-outline dropdown-toggle" style="float:right;"></i>
                                        </a>
                                          <div tabindex="-2" role="menu" aria-hidden="true" class="dropdown-menu-sm rm-pointers dropdown-menu dropdown-menu-left">
                                              <div class="scroll-area-xs">
                                                  <div class="scrollbar-container">
                                                      <ul class="nav flex-column">
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">All Courier</a></li>
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Verify Admins</a></li>
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">View Automobiles</a></li>
                                                      <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Settings</a></li>
                                                      </ul>
                                                  </div>
                                              </div>
                                          </div>
                                        ...
                                        <a class="dropdown-item" href="#">User List Helpdesk</a>
                                        <a class="dropdown-item" href="#">Account(Wallet)</a>
                                        <a class="dropdown-item" href="#">Know Your Customer</a>
                                                    ...
                                                    <div class="rm-border card-header">
                                                        ...
                                                        <div class="btn-actions-pane-right text-capitalize">
                                                            <div class="btn-group dropdown">
                                                                ...
                                                                class="btn-wide mr-1 dropdown-toggle btn btn-outline-focus btn-sm">
                                                                Options
                                                              </button>
